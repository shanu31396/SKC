...
int main(){
    ...
    This was the major problem with the languages like C which relied upon functions or procedures (hence, named procedural oriented programming language)
    ...
    **************************************Decomposes the problem in OBJECTS and builds data and function around OBJECTS **************************************
