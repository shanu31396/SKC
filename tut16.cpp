...
int main(){
    // ONE THING TO KEEP HERE IN MIND IS THAT WE HAVE USED THE FUNCTIONS IN A CONSECUTIVE MANNER SO THE VALUE OF X AND Y WILL BE UPGRADED FOR EACH NEXT FUNCTION    
    int x,y;
    ...
    // swap(x,y);       this won't swap values
    /* the belowl line will swap a and b using pointer reference*/ 
